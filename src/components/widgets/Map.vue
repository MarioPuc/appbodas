<template>
  <div>
    <div v-if="tipoUbicacion == 'evento'">
      ...
      <gmap-map
        :center="evento.locacionEvento"
        :zoom="14"
        style="width: 100%; height: 200px"
      >

        <gmap-marker
          :position="evento.locacionEvento"
    ...
    <div v-else-if="tipoUbicacion == 'ceremonia'">
      ...
      <gmap-map
        :center="evento.locacionCeremonia"
        :zoom="14"
        style="width: 100%; height: 200px"
      >
        <gmap-marker
            :position="evento.locacionCeremonia"
            title="Ubicación del evento"
            :clickable="true"
            :draggable="isDraggable"
            @dragend="updateCoordinates"
    ...
    <div v-else="tipoUbicacion == 'ceremoniaAdicional'">
      ...
      <gmap-map
        :center="evento.locacionCeremoniaAdicional"
        :zoom="14"
        style="width: 100%; height: 200px"
      >
        <gmap-marker
            :position="evento.locacionCeremoniaAdicional"
            title="Ubicación del evento"
            :clickable="true"
            :draggable="isDraggable"
            @dragend="updateCoordinates"
