    ...
    <div class="container full-height">
        <v-container fill-height fluid>
          ...
          <div>
            ...
            <div class="text-center font white--text " style="font-family: GaramondMedIt; font-size: 60px; line-height: 30px;">
              SHINE
            </div>

            <div class="text-center font white--text " style="font-family: SofiaProRegular; font-size: 24px; line-height: 40px;">IT'S BIRTHDAY TIME!</div>
            
            <div class="text-center font white--text " style="font-family: SofiaProRegular; font-size: 30px; line-height: 35px; letter-spacing: 2px;">PATTY'S</div>

            <div class="text-center font white--text " style="font-family: Colatin; font-size: 100px; line-height: 80px;">30 <sup style="font-family: Colatin; font-size: 60px;">th</sup></div>

            <div class="text-center font white--text " style="font-family: SofiaProRegular; font-size: 30px; line-height: 35px; letter-spacing: 5px;">PARTY</div>


            <div class="text-center font white--text " style="font-family: GaramondMedIt; font-size: 50px; line-height: 65px; letter-spacing: 1px;">21/ENE/23</div>

            <div class="text-center font white--text " style="font-family: SofiaProRegular; font-size: 20px; letter-spacing: 1px;">CALLE 25 N° 303 X 4 Y 6 <br> FRACC: MONTEBELLO</div>
